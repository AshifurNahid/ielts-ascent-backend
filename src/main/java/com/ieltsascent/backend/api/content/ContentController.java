...
public class ContentController {
    ...
    @GetMapping("/reading")
    public ApiResponse<PageResponse<ReadingPassageDto>> reading(@ParameterObject Pageable pageable) {
        Page<ReadingPassageDto> page = contentService.listReadingPassages(pageable)
            .map(ReadingPassageDto::from);
    ...
    public record ReadingPassageDto(UUID id, String title, String description, String difficulty) {
        public static ReadingPassageDto from(ReadingPassage passage) {
